...
class MetaDynamicsModel(pytorch_lightning.LightningModule):
    ...
    def forward(self, x, domains, controls, generation_training_len):
    ...
    def get_step_outputs(self, batch, generation_len):
        ...
        indices, signals, domains, labels, controls = batch

        # Get predictions
        preds = self(signals, domains, controls, generation_len)
    ...
    def training_step(self, batch, batch_idx):
        ...
        likelihood, dynamics_loss = self.get_step_losses(signals, controls, preds, is_train=True)
