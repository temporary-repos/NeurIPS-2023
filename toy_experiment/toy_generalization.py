...
from utils.dataloader import PercentODEData, MetaPercentODEData
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config_path', type=str, default='configs/bounds_experiments/SlowBounds_Additive.json',
    ...
    if args.meta is True:
        ...
        dataset = PercentODEData(args, x_initial=10, bounds=(args.bound_start, args.bound_end),
                                 u_start=args.u_start, u_end=args.u_end,
                                 is_interpolation=args.interpolation, is_train=args.train)
